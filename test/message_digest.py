...
class SipClient(SipListener):
	...
	def run(self):
		# users
		fromUser = 'ITSY000001';
		fromAuthUser = 'ITSY000001.priv@brn38.iit.ims';
		fromAuthUserPassword = '33800000001';
		fromDomain= 'brn38.iit.ims';
		fromDisplayName = 'ITSY000001';
		...
		authorizationHeader.setUserName(fromAuthUser)
		authorizationHeader.setRealm(fromDomain)
		authorizationHeader.setUri(fromDomain)
		authorizationHeader.setNonce('')
		authorizationHeader.setResponse('')
		m.addHeader(authorizationHeader)
